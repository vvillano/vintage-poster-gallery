...
const COUNTRIES = [
  ...
  { name: 'China', code: 'CN' },
  { name: 'Cuba', code: 'CU' },
  { name: 'Czechoslovakia', code: 'CS', aliases: ['Former Czechoslovakia'] },
  { name: 'Czech Republic', code: 'CZ' },
  { name: 'Denmark', code: 'DK' },
  { name: 'East Germany', code: 'DD', aliases: ['DDR', 'German Democratic Republic'] },
  { name: 'Egypt', code: 'EG' },
  ...
  { name: 'Poland', code: 'PL' },
  { name: 'Russia', code: 'RU' },
  { name: 'Soviet Union', code: 'SU', aliases: ['USSR', 'U.S.S.R.'] },
  { name: 'Spain', code: 'ES' },
  { name: 'Sweden', code: 'SE' },
