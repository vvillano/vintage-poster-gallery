...
/**
 * Run the platform consolidation migration
 */
async function runPlatformConsolidation(): Promise<string[]> {
...
/**
 * POST /api/migrate/platform-consolidation
 *
 * Run the migration (used by the Migrations UI page)
 */
export async function POST() {
  try {
    const results = await runPlatformConsolidation();
